...
HD_PWD='/afs/athena.mit.edu/user/n/k/nkk/fpga_6115/HFT/parser/parser.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parser_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parser_top.tcl
