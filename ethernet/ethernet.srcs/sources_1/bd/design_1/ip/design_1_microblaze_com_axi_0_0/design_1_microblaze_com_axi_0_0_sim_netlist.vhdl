...
-- Date        : Tue Nov 19 18:33:04 2019
-- Host        : eecs-digital-37 running 64-bit Ubuntu 14.04.6 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /afs/athena.mit.edu/user/n/k/nkk/fpga_6115/HFT/ethernet/ethernet.srcs/sources_1/bd/design_1/ip/design_1_microblaze_com_axi_0_0/design_1_microblaze_com_axi_0_0_sim_netlist.vhdl
-- Design      : design_1_microblaze_com_axi_0_0
...
entity design_1_microblaze_com_axi_0_0_master_axi_stream is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_microblaze_com_axi_0_0_master_axi_stream : entity is "master_axi_stream";
end design_1_microblaze_com_axi_0_0_master_axi_stream;

architecture STRUCTURE of design_1_microblaze_com_axi_0_0_master_axi_stream is
  ...
  attribute FSM_ENCODED_STATES of \FSM_sequential_mst_exec_state_reg[0]\ : label is "IDLE:00,INIT_COUNTER:01,SEND_STREAM:10";
  attribute FSM_ENCODED_STATES of \FSM_sequential_mst_exec_state_reg[1]\ : label is "IDLE:00,INIT_COUNTER:01,SEND_STREAM:10";
...
\stream_data_out[5]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0020"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_microblaze_com_axi_0_0_slave_axi_stream is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_microblaze_com_axi_0_0_slave_axi_stream : entity is "slave_axi_stream";
end design_1_microblaze_com_axi_0_0_slave_axi_stream;

architecture STRUCTURE of design_1_microblaze_com_axi_0_0_slave_axi_stream is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_microblaze_com_axi_0_0_microblaze_com_axi is
  port (
    m00_axis_tvalid : out STD_LOGIC;
    m00_axis_tdata : out STD_LOGIC_VECTOR ( 4 downto 0 );
    m00_axis_tlast : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_microblaze_com_axi_0_0_microblaze_com_axi : entity is "microblaze_com_axi";
end design_1_microblaze_com_axi_0_0_microblaze_com_axi;

architecture STRUCTURE of design_1_microblaze_com_axi_0_0_microblaze_com_axi is
begin
master_axi_test_v1_0_M00_AXIS_inst: entity work.design_1_microblaze_com_axi_0_0_master_axi_stream
     port map (
...
master_axi_test_v1_0_S00_AXIS_inst: entity work.design_1_microblaze_com_axi_0_0_slave_axi_stream
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_microblaze_com_axi_0_0 is
  port (
    s00_axis_aclk : in STD_LOGIC;
    s00_axis_aresetn : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_microblaze_com_axi_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_microblaze_com_axi_0_0 : entity is "design_1_microblaze_com_axi_0_0,microblaze_com_axi,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_microblaze_com_axi_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of design_1_microblaze_com_axi_0_0 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_microblaze_com_axi_0_0 : entity is "microblaze_com_axi,Vivado 2019.1.2";
end design_1_microblaze_com_axi_0_0;

architecture STRUCTURE of design_1_microblaze_com_axi_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of m00_axis_tready : signal is "XIL_INTERFACENAME m00_axis, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 1, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_1_clk_out1, LAYERED_METADATA undef, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of m00_axis_tvalid : signal is "xilinx.com:interface:axis:1.0 m00_axis TVALID";
  attribute X_INTERFACE_INFO of s00_axis_aclk : signal is "xilinx.com:signal:clock:1.0 s00_axis_aclk CLK";
  attribute X_INTERFACE_PARAMETER of s00_axis_aclk : signal is "XIL_INTERFACENAME s00_axis_aclk, ASSOCIATED_BUSIF s00_axis, ASSOCIATED_RESET s00_axis_aresetn, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_1_clk_out1, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of s00_axis_tvalid : signal is "XIL_INTERFACENAME s00_axis, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 1, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_1_clk_out1, LAYERED_METADATA undef, INSERT_VIP 0";
...
begin
  ...
  m00_axis_tdata(5) <= \^m00_axis_tdata\(3);
  m00_axis_tdata(4 downto 0) <= \^m00_axis_tdata\(4 downto 0);
...
inst: entity work.design_1_microblaze_com_axi_0_0_microblaze_com_axi
     port map (
      m00_axis_aclk => m00_axis_aclk,
      m00_axis_aresetn => m00_axis_aresetn,
      m00_axis_tdata(4) => \^m00_axis_tdata\(3),
      m00_axis_tdata(3) => \^m00_axis_tdata\(4),
